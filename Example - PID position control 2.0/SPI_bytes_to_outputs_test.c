/*
 * File: SPI_bytes_to_outputs_test.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Oct 23 21:28:13 2017
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SPI_bytes_to_outputs_test
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       analog0
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       analog1
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       analog2
...
extern void SPI_bytes_to_outputs_test_Outputs_wrapper(const uint8_T *read,
			real_T *dutyCycle,
			int32_T *enc1count,
			uint16_T *analog0,
			uint16_T *analog1,
			...
			real_T *analog6,
			const real_T *xD);
extern void SPI_bytes_to_outputs_test_Update_wrapper(const uint8_T *read,
			real_T *dutyCycle,
			int32_T *enc1count,
			uint16_T *analog0,
			uint16_T *analog1,
...
{
    const uint8_T *read = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    ...
    SPI_bytes_to_outputs_test_Outputs_wrapper(read, dutyCycle, enc1count, analog0, analog1, analog2, analog3, analog6, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    SPI_bytes_to_outputs_test_Update_wrapper(read, dutyCycle, enc1count, analog0, analog1, analog2, analog3, analog6, xD);
}
#endif /* MDL_UPDATE */
