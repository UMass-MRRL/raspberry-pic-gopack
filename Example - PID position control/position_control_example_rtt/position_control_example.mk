# File name: position_control_example.mk
# Autogenerated on: 24-Feb-2017 11:57:36
# Copyright 2009-2012 The MathWorks, Inc.
#
# Model: POSITION_CONTROL_EXAMPLE
# Template: gmake 
...
EMPTY                :=
SPACE                := $(EMPTY) $(EMPTY)
MODEL_NAME           := position_control_example
...
MATLAB_ROOT_RELATIVE := ..\..\..\..\..\Program Files\MATLAB\R2015b\#MATLAB_ROOT_RELATIVE_END
...
SOURCE_FILES        := $(call FORMAT_PATH,.\linuxUDP.c) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\rtiostream_interface.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\rtiostream_tcpip.c) $(call FORMAT_PATH,.\rtiostream_utils.c) $(call FORMAT_PATH,.\SPI_bytes_to_outputs_wrapper.c) $(call FORMAT_PATH,.\SPI_wrapper.c) $(call FORMAT_PATH,.\inputs_to_SPI_bytes_wrapper.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\position_control_example.c) $(call FORMAT_PATH,.\position_control_example_data.c)
HEADER_FILES        := $(call FORMAT_PATH,..\..\..\..\..\Program Files\MATLAB\R2015b\rtw\c\src\ext_mode\common\ext_svr.h) $(call FORMAT_PATH,..\..\..\..\..\Program Files\MATLAB\R2015b\rtw\c\src\ext_mode\common\ext_work.h) $(call FORMAT_PATH,..\..\..\..\..\Program Files\MATLAB\R2015b\rtw\c\src\ext_mode\common\updown.h) $(call FORMAT_PATH,..\..\..\..\..\Program Files\MATLAB\R2015b\toolbox\coder\rtiostream\src\utils\rtiostream_utils.h) $(call FORMAT_PATH,.\position_control_example.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/Users/Mark/Desktop/Example - PID position control/position_control_example_rtt" -I"C:/Users/Mark/Desktop/Example - PID position control" -I"C:/Program Files/MATLAB/R2015b/extern/include" -I"C:/Program Files/MATLAB/R2015b/simulink/include" -I"C:/Program Files/MATLAB/R2015b/rtw/c/src" -I"C:/Program Files/MATLAB/R2015b/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2015b/rtw/c/ert" -I"C:/Program Files/MATLAB/R2015b/toolbox/coder/rtiostream/src/utils" -I"C:/Program Files/MATLAB/R2015b/toolbox/shared/dspblks/extern/include" -I"C:/Program Files/MATLAB/R2015b/rtw/c/src/rtiostream/rtiostreamtcpip" -O3 -D"MODEL=position_control_example" -D"NUMST=2" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ON_TARGET_WAIT_FOR_START=1" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=1" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLETESTING="
COMPILER_TCCFG_ARGS   := -c
COMPILER_ARGS         := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)
LINKER_CODEGEN_ARGS   :=  -lwiringPi  -lm -ldl -lpthread -lrt 
