...
{
    const real_T   *dutyCycle  = (const real_T*) ssGetInputPortSignal(S,0);
    uint8_T        *write  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    inputs_to_SPI_bytes_Outputs_wrapper(dutyCycle, write, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    inputs_to_SPI_bytes_Update_wrapper(dutyCycle, write,  xD);
}
