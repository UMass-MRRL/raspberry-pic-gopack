...
Note: If you are using the Raspberry Pi 2 Model B with MATLAB Simulink version 2015b, then please scroll further down the README.
...
# RaspberryPIC GoPack (OLDER VERSION)
